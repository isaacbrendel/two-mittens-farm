    ...
    new Vue({
        ...
        methods: {
            async fetchAvailableSlots() {
                ...
                try {
                    const response = await axios.get(`/api/slots/?date=${this.bookingForm.date}`);
            ...
            async submitBooking() {
                try {
                    const response = await axios.post('/api/bookings/', this.bookingForm);
            ...
            async processMembership() {
                try {
                    ...
                    const response = await axios.post('/api/membership/signup/', {
                        membership_type: this.selectedPlan,
                        ...this.membershipForm
                    });
                    if (response.data.status === 'success') {
